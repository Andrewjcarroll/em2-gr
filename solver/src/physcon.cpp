...
#include "../gencode/solver_physcon_deriv_calc.cpp.inc"
    // clang-format on
    //[[[end]]]
    double *rho_e = deriv_base + 6 * BLK_SZ;
...
// #include "../gencode/solver_physcon_deriv_calc.cpp.inc"
    ...
    SOLVER_DERIVS->grad_x(grad_0_A0, A0, hx, sz, bflag);
    SOLVER_DERIVS->grad_y(grad_1_A1, A1, hy, sz, bflag);
    SOLVER_DERIVS->grad_z(grad_2_A2, A2, hz, sz, bflag);
